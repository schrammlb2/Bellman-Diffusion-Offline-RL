...
if __name__ == "__main__":
    ...
    config = {
        ...
        "action_reg_weight": tune.qloguniform(0.0001, 0.1, 0.0001),
    ...
    num_samples = 100
    trainable_with_resources = tune.with_resources(trainable, {"gpu": 0.5})
    # args_for_exp.device = "cpu"
