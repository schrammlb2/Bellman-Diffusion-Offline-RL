...
class BoundedVarianceISPolicy(BasePolicy):
    """
    ...
    def __init__(
        self,
        bc_actor: nn.Module,
        value_actor: nn.Module,
        critic_q1: nn.Module,
        critic_q2: nn.Module,
        critic_v: nn.Module,
        bc_actor_optim: torch.optim.Optimizer,
        value_actor_optim: torch.optim.Optimizer,
        ...
        self.bc_actor_optim = bc_actor_optim
        self.value_actor_optim = value_actor_optim
