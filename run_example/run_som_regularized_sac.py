...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="som_regularized_sac")
    ...
    parser.add_argument("--state-reg-weight", type=float, default=10.)
...
def train(args=get_args()):
    ...
    # create policy
    policy = SOMRegularizedSACPolicy(
        actor,
        critic1,
        critic2,
        diffusion_model,
