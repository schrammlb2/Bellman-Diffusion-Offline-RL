...
from offlinerlkit.modules import DiffusionNetwork, GenericDiffusionNetwork
...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="semi_mb_combo")
...
def train(args=get_args()):
    ...
    # create policy
    policy = MBStoredSemiMBCOMBO2Policy(
        actor,
        critic1,
        critic2,
        diffusion_model,
