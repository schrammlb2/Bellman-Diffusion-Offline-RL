...
def train_meta(config: Config):
    ...
    ray.init(_temp_dir="/common/home/lbs105/ray/", num_cpus=1, num_gpus=4)

    ray_config = vars(config)
    ray_config["relative_state_bc_coef"]= tune.grid_search([1, 10, 100])
    ray_config["div"]= tune.grid_search([1, 10, 100])
